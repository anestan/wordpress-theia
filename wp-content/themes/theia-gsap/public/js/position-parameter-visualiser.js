...
(() => {
/*!*******************************************************!*\
  !*** ./resources/js/position-parameter-visualiser.js ***!
  \*******************************************************/
__webpack_require__.r(__webpack_exports__);
...
gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.registerPlugin(gsap_GSDevTools__WEBPACK_IMPORTED_MODULE_1__.GSDevTools); // GSDevTools.create();
...
for (var i = 0; i < numChildren; i++) {
  gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.set('#tween' + i, {
    x: children[i].startTime() * pixelsPerSecond
  });
  gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.set('#rect' + i, {
    width: children[i].duration() * pixelsPerSecond
  });
}

var dragger = gsap_Draggable__WEBPACK_IMPORTED_MODULE_2__.Draggable.create('#playhead', {
  type: 'x',
  cursor: 'pointer',
  trigger: '#timeline',
  bounds: {
...
function movePlayhead() {
  gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.set('#playhead', {
    x: animation.progress() * maxX
  });
  time.textContent = animation.time().toFixed(1);
}
...
/******/ })()
;
//# sourceMappingURL=position-parameter-visualiser.js.map