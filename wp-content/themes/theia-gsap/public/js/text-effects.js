...
gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.registerPlugin(gsap_GSDevTools__WEBPACK_IMPORTED_MODULE_1__.GSDevTools, gsap_TextPlugin__WEBPACK_IMPORTED_MODULE_2__.TextPlugin, gsap_SplitText__WEBPACK_IMPORTED_MODULE_3__.SplitText);
gsap_GSDevTools__WEBPACK_IMPORTED_MODULE_1__.GSDevTools.create();
gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.to('.typewriter-text', {
...
var tbt = new gsap_SplitText__WEBPACK_IMPORTED_MODULE_3__.SplitText('.letter-by-letter-text', {
  type: 'chars'
});
var tbt_tl = gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.timeline({
  repeat: 10,
  yoyo: true,
  repeatDelay: 0.3
});
tbt_tl.from(tbt.chars, {
  opacity: 0,
  y: 50,
  ease: 'back(4)',
  stagger: 0.05
});
var wbw = new gsap_SplitText__WEBPACK_IMPORTED_MODULE_3__.SplitText('.word-by-word-text', {
  type: 'words'
});
var wbw_tl = gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.timeline({
  repeat: 10,
  yoyo: true,
  repeatDelay: 0.3
});
wbw_tl.from(wbw.words, {
  opacity: 0,
  rotation: -40,
  scale: 0.4,
  stagger: 0.1,
...
var nbn = new gsap_SplitText__WEBPACK_IMPORTED_MODULE_3__.SplitText('.line-by-line-text', {
  type: 'lines'
});
var nbn_tl = gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.timeline({
  repeat: 10,
  repeatDelay: 1
});
nbn_tl.from(nbn.lines, {
  opacity: 0,
  rotationX: -90,
  rotationY: -80,
  stagger: 0.2,
...
var mySplitText = new gsap_SplitText__WEBPACK_IMPORTED_MODULE_3__.SplitText('.my-split-text', {
  type: 'words'
});
var splitTextTimeline = gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.timeline({
  repeat: 10
});
mySplitText.split({
...
splitTextTimeline.from(mySplitText.chars, {
  ...
  force3D: true,
  stagger: 0.01
}, 0.5).to(mySplitText.words, {
  duration: 0.1,
  color: '#8FE402',
  scale: 0.9,
  stagger: 0.1
}, 'words').to(mySplitText.words, {
  duration: 0.2,
  color: '#eeeeee',
  scale: 1,
  stagger: 0.1
}, 'words+=0.1').to(mySplitText.lines, {
  duration: 0.5,
  x: 100,
  autoAlpha: 0,
  stagger: 0.2
...
/******/ })()
;
//# sourceMappingURL=text-effects.js.map