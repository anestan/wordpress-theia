...
update_option('oxygen_license_key' ,'05801BAD536B47CC85DBCBD391FD5EAB');
...
update_option('oxypowerpack_sass_enabled','true');
update_option('oxygen_woocommerce_license_key','05801BAD536B47CC85DBCBD391FD5EAB');
update_option('oxygen_woocommerce_license_site_hash',true);
update_option('oxygen_woocommerce_license_status','valid');
update_option('OxyPowerPack_license_key','05801BAD536B47CC85DBCBD391FD5EAB');
update_option('OxyPowerPack_license_status','valid');
update_option('OxyPowerPack_license_status',true);
