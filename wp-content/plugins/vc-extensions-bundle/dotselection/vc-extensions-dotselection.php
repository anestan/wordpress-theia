...
if (!class_exists('VC_Extensions_DotSelection')){
    class VC_Extensions_DotSelection{
        ...
        function __construct() {
            vc_map(array(
            "name" => __("Dot Selection", 'cq_allinone_vc'),
            ...
            'description' => __('Color dot with slide', 'js_composer'),
            "params" => array(
              array(
                "type" => "dropdown",
                "holder" => "",
                "heading" => __("Dot border type:", "cq_allinone_vc"),
              ...
              array(
                ...
                "edit_field_class" => "vc_col-xs-6 vc_column",
                "class" => "",
                "heading" => __("Dot shape", "cq_allinone_vc"),
                "param_name" => "dotshape",
                "value" => array('Rounded' => 'rounded', 'Square' => 'square', 'Round' => 'round'),
                'std' => 'round',
                "description" => __("", "cq_allinone_vc")
        ...
        vc_map(
          array(
             ...
             "params" => array(
              array(
                "type" => "textfield",
                "heading" => __("Tooltip for the dot (optional)", "cq_allinone_vc"),
                "param_name" => "tooltip",
                "value" => "",
                "description" => __("", "cq_allinone_vc")
              ),
              array(
                ...
                "heading" => __("Dot color for current slide", 'cq_allinone_vc'),
                "param_name" => "dotcolor",
                "value" => "",
                "description" => __("", 'cq_allinone_vc')
              ),
