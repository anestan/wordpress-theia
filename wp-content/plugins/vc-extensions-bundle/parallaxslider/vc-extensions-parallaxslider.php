...
if (!class_exists('VC_Extensions_ParallaxSlider')){
    class VC_Extensions_ParallaxSlider{
        ...
        function __construct() {
            vc_map(array(
            "name" => __("Parallax Slider", 'cq_allinone_vc'),
            ...
            "params" => array(
              ...
              array(
                ...
                "edit_field_class" => "vc_col-xs-6 vc_column",
                "class" => "",
                "heading" => __("Arrow button position", "cq_allinone_vc"),
              ...
              array(
                ...
                "edit_field_class" => "vc_col-xs-6 vc_column",
                "class" => "",
                "heading" => __("Arrow button shape", "cq_allinone_vc"),
              ...
              array(
                ...
                "heading" => __("Arrow color:", "cq_allinone_vc"),
              ...
              array(
                "type" => "colorpicker",
                "edit_field_class" => "vc_column vc_col-xs-6",
                "heading" => __("Arrow hover color:", "cq_allinone_vc"),
              ...
              array(
                "type" => "colorpicker",
                "edit_field_class" => "vc_column vc_col-xs-6",
                "heading" => __("Arrow button background color:", "cq_allinone_vc"),
                "param_name" => "arrowbg",
                "value" => "",
                "dependency" => Array('element' => "buttonposition", 'value' => array('left', 'right')),
                "description" => __("", "cq_allinone_vc")
              ...
              array(
                "type" => "colorpicker",
                "edit_field_class" => "vc_column vc_col-xs-6",
                "heading" => __("Arrow hover background color:", "cq_allinone_vc"),
              ...
              array(
                "type" => "colorpicker",
                "edit_field_class" => "vc_column vc_col-xs-6",
                "heading" => __("Caption text color:", 'cq_allinone_vc'),
              ...
              array(
                ...
                "value" => "",
                "description" => __("Default is gray with transparent.", 'cq_allinone_vc')
              ),
              array(
                "type" => "dropdown",
                "holder" => "",
        ...
        vc_map(
          array(
             ...
             "category" => __("Sike Extensions", "js_composer"),
             "description" => __("Add image, text","cq_allinone_vc"),
      ...
      function cq_vc_parallaxslider_item_func($atts, $content=null, $tag) {
          ...
          $image_str .= '<div class="cq-parallaxslider-image" style="background-image:url('.$thumbnail.');background-color:'.$iconbg.'; ">';
